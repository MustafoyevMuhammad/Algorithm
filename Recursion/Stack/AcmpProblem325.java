...
public class AcmpProblem325
{
        ...
        public static void main(String[] args)
        {
            ...
            x2 = values[1].charAt(0) - 96;
            y2 = values[1].charAt(1) - 48;
            // N x N matrix
            int N = 8;

            // source coordinates
            Node src = new Node(x1 - 1, y1 - 1);

            // destination coordinates
            Node dest = new Node(x2 - 1, y2 - 1);

            int n =findShortestDistance(src, dest, N);
